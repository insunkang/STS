...
public class BoardController {
	...
	public ModelAndView boardList(String category) {
		...
		System.out.println("zkzkzk");
		//3. 데이터공유 - jsp페이지에서 응답뷰 만들때 사용
		//	 => 기본값 : request에 저장
	...
	//Ajax로 카테고리별 게시판 데이터를 요청하는 메소드 @ResponseBody => json으로 만들어줌
	// => 컨트롤러 메소드처럼 ModelAndView를 리턴하지 않고 일반 메소드 처럼 조회한 데이터를
	//	  ArrayList로 리턴하면 jackson라이브러리가 자동으로 ArrayList<BoardVO>를 json
	// 	   으로 변환해서 리턴해준다.
